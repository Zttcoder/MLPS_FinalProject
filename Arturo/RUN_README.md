# How to read an experiment folder
...
Throughout this guide, the example folder is:

- [aligned_run](https://github.com/Zttcoder/MLPS_FinalProject/tree/Developing/Arturo/aligned_run)

In that example:

- the public folder name is `aligned_run`
- the internal run timestamp is `20260418_214955`
- the matching notebook is [`two_stage_aaarias_aligned_run.ipynb`](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/two_stage_aaarias_aligned_run.ipynb)
- the experiment came from a notebook using a two-stage direct tabular model
- the experiment evaluated horizons `24` and `48`
- the selected best pair for both horizons was `xgb_classifier + xgb_regressor`

## Run aliases used in this repository

The repository contains several closely related two-stage notebooks and published experiment folders.

The published folder names are the ones you should use when browsing the repository.

The internal `run_YYYYMMDD_HHmmss` timestamp is still useful, but now mainly for:

- report filenames such as `run_20260418_214955_report.pdf`
- artifact metadata
- provenance inside `config.json`, `environment.json`, and manifests
- mapping a public folder back to the original training run
...
The table below maps the main notebook variants to the published folders used in the repository.
...
For the most detailed reference of what each variant is trying to do, see the notebook files in this folder:

- [Arturo](https://github.com/Zttcoder/MLPS_FinalProject/tree/Developing/Arturo)

## 1. Big picture: what an experiment folder is

A published experiment folder such as `aligned_run/` or `50features_2fold/` is a self-contained experiment record.
...
In other words, each published folder is meant to be an experiment snapshot.

## 2. Typical experiment folder structure

Using `aligned_run/` as the example, the folder root contains:
...
├── config.json
├── environment.json
├── run_20260418_214955_report.pdf
...
- so if you browse a shared experiment folder in the repository, `checkpoints/` may be missing on purpose
...
- [config.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/config.json)
...
- [environment.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/environment.json)
...
- [selected_weather_features.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/selected_weather_features.json)
...
- [artifact_manifest.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/artifact_manifest.json)
...
- [tables/run_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/run_summary.csv)
...
- [tables/backtest_folds.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/backtest_folds.csv)
...
- [tables/pair_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/pair_summary.csv)
...
- [tables/candidate_fold_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/candidate_fold_summary.csv)
...
- [tables/best_pair_by_horizon.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/best_pair_by_horizon.csv)
...
- [tables/best_candidate_model_by_horizon.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/best_candidate_model_by_horizon.csv)
...
- [tables/submission_model_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/submission_model_summary.csv)

This is one of the most important files in the whole experiment folder.
...
- [tables/final_refit_validation_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/final_refit_validation_summary.csv)
...
- [tables/classifier_stage_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/classifier_stage_summary.csv)
...
- [tables/regressor_stage_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/regressor_stage_summary.csv)
...
- [tables/selected_weather_features.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/selected_weather_features.csv)
...
- [tables/feature_frame_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/feature_frame_summary.csv)
...
- [tables/eda_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/eda_summary.csv)
...
- [predictions/two_stage_pred_24h.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/predictions/two_stage_pred_24h.csv)
- [predictions/two_stage_pred_48h.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/predictions/two_stage_pred_48h.csv)
...
- [predictions/final_refit_pred_24h.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/predictions/final_refit_pred_24h.csv)
- [predictions/final_refit_pred_48h.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/predictions/final_refit_pred_48h.csv)
...
- [predictions/pair_h24__clf_xgbc01__reg_xgbr01_f01_val_predictions.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/predictions/pair_h24__clf_xgbc01__reg_xgbr01_f01_val_predictions.csv)
...
- [models/submission_bundle_h24_metadata.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/models/submission_bundle_h24_metadata.json)
- [models/submission_bundle_h48_metadata.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/models/submission_bundle_h48_metadata.json)
...
- [models/final_bundle_h24_metadata.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/models/final_bundle_h24_metadata.json)
- [models/final_bundle_h48_metadata.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/models/final_bundle_h48_metadata.json)
...
- [metrics/pair_h24__clf_xgbc01__reg_xgbr01_fold_metrics.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/metrics/pair_h24__clf_xgbc01__reg_xgbr01_fold_metrics.csv)
...
- [metrics/pair_h24__clf_xgbc01__reg_xgbr01_f01_stage1_history.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/metrics/pair_h24__clf_xgbc01__reg_xgbr01_f01_stage1_history.json)
- [metrics/pair_h24__clf_xgbc01__reg_xgbr01_f01_stage2_history.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/metrics/pair_h24__clf_xgbc01__reg_xgbr01_f01_stage2_history.json)
...
- [metrics/demo_eval_24h.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/metrics/demo_eval_24h.json)
- `demo_eval_48h.json`
...
## 8. How to answer common questions using the experiment folder
...
## 9. A practical walkthrough with `aligned_run`

If someone gave you the `aligned_run/` folder and asked, “What happened here?”, a good workflow would be:

1. Open [config.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/config.json)
   - confirm horizons, split strategy, feature settings, and whether GPU was enabled

2. Open [environment.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/environment.json)
   - confirm the platform and package versions

3. Open [tables/backtest_folds.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/backtest_folds.csv)
   - confirm the exact train/validation windows

4. Open [tables/pair_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/pair_summary.csv)
   - compare all candidate pairs

5. Open [tables/best_pair_by_horizon.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/best_pair_by_horizon.csv)
   - identify the winners

6. Open [tables/submission_model_summary.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/tables/submission_model_summary.csv)
   - see which concrete artifacts generated the exported predictions

7. Open [predictions/two_stage_pred_24h.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/predictions/two_stage_pred_24h.csv) and [predictions/two_stage_pred_48h.csv](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/predictions/two_stage_pred_48h.csv)
   - inspect the final exported outputs

8. Open [models/submission_bundle_h24_metadata.json](https://github.com/Zttcoder/MLPS_FinalProject/blob/Developing/Arturo/aligned_run/models/submission_bundle_h24_metadata.json)
...
This is normal if the experiment was executed in Colab or on a machine where the notebook used that root.
...
If it is missing from a shared experiment folder, that does not mean the run is incomplete.
...
- how the experiment was configured
- which model won
